...
/obj/item/ammo_casing/energy/ms13/laser/eyebot/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/energy/electrode/ms13/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/energy/ms13/laser/protectron/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/ms13/nail/protectron/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/energy/ms13/laser/robobrain/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/ms13/a762/junk/handy/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/energy/ms13/plasma/gutsy/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)
...
/obj/item/ammo_casing/energy/ms13/laser/assaultron/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	. = ..()
	if(. && !QDELETED(src))
		qdel(src)

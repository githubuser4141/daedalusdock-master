...
/datum/unit_test/ms13_terrain_hiveminds/Run()
	...
	var/turf/doorway = get_turf(ambusher)
	var/obj/machinery/door/unpowered/ms13/metal/ambush_door = new(doorway)
	TEST_ASSERT(!ambusher.good_ambush_spot(), "The ambusher would lie in wait in a doorway.")
	qdel(ambush_door)

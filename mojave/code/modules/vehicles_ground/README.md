...
already open menu). The attached monitor remains clickable and follows vehicle movement/rotation.
...
Releasing the controls, stopping the engine, or leaving the seat **does not stop the vehicle**.

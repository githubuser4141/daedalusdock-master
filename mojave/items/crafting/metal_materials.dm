...
GLOBAL_LIST_INIT(scrap_recipes, list ( \
	new/datum/stack_recipe("wall supports", /obj/structure/girder/ms13/bars, 4, time = 20 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
...
GLOBAL_LIST_INIT(scrap_steel_recipes, list ( \
	new/datum/stack_recipe("wall supports", /obj/structure/girder/ms13/bars, 3, time = 20 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \

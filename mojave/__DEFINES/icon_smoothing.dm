...
// low-wall furniture) uses S_OBJ, continuing DD's own numbering (turf max 57, obj max 71).
...
#define SMOOTH_GROUP_MS13_DESERT S_TURF(58)			///turf/open/floor/plating/ground/desert
#define SMOOTH_GROUP_MS13_SNOW S_TURF(59)			///turf/open/floor/plating/ms13/ground/snow
#define SMOOTH_GROUP_MS13_ROAD S_TURF(60)			///turf/open/floor/plating/ground/road
#define SMOOTH_GROUP_MS13_SIDEWALK S_TURF(61)			///turf/open/floor/plating/ground/sidewalk
#define SMOOTH_GROUP_MS13_TILE S_TURF(62)			///turf/open/floor/wood/ms13, /turf/open/floor/ms13/
#define SMOOTH_GROUP_MS13_ICE S_TURF(63)			///turf/open/floor/plating/ms13/ground/ice
#define SMOOTH_GROUP_MS13_WATER S_TURF(64)		///turf/open/ms13/water

#define SMOOTH_GROUP_MS13_LOW_WALL S_OBJ(81)			///obj/structure/table/ms13/low_wall
#define SMOOTH_GROUP_MS13_CARPET_RED S_TURF(65)			////turf/open/floor/wood/ms13/carpet/red
#define SMOOTH_GROUP_MS13_CARPET_BLUE S_TURF(66)			////turf/open/floor/wood/ms13/carpet/blue
#define SMOOTH_GROUP_MS13_CARPET_GREEN S_TURF(67)			////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_VIOLET S_TURF(68)			////turf/open/floor/wood/ms13/carpet/violet
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_RED S_TURF(69)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_BLUE S_TURF(70)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_GREEN S_TURF(71)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_VIOLET S_TURF(72)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_ROOF_NORMAL S_TURF(73)			////turf/open/floor/plating/roof
#define SMOOTH_GROUP_MS13_ROOF_SHEET S_TURF(74)			////turf/open/floor/plating/roof/sheet
#define SMOOTH_GROUP_MS13_ROOF_METAL S_TURF(75)			////turf/open/floor/plating/roof/metal
#define SMOOTH_GROUP_MS13_ROOF_WOOD S_TURF(76)			////turf/open/floor/plating/roof/wood
#define SMOOTH_GROUP_MS13_GLASS S_OBJ(82)			///obj/structure/ms13/glassfloor

#define SMOOTH_GROUP_MS13_OPENSPACE S_TURF(77)			///turf/open/openspace/ms13

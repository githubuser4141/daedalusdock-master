#define WALL_OBJECT_SMOOTHING SMOOTH_GROUP_MS13_LOW_WALL + SMOOTH_GROUP_MS13_WINDOW + SMOOTH_GROUP_MS13_MINERALS + SMOOTH_GROUP_MS13_WALL_REINFORCED + SMOOTH_GROUP_MS13_WALL_BRICK + SMOOTH_GROUP_MS13_WALL_ADOBE + SMOOTH_GROUP_MS13_WALL_SCRAP + SMOOTH_GROUP_MS13_WALL_WOOD + SMOOTH_GROUP_MS13_WALL_METAL + SMOOTH_GROUP_MS13_WALL
#define WALL_SMOOTHING WALL_OBJECT_SMOOTHING + SMOOTH_GROUP_MS13_SIDEWALK
#define DESERT_SMOOTHING SMOOTH_GROUP_MS13_DESERT + SMOOTH_GROUP_MS13_SNOW + SMOOTH_GROUP_MS13_ROAD + SMOOTH_GROUP_MS13_SIDEWALK + SMOOTH_GROUP_MS13_TILE + SMOOTH_GROUP_MS13_WATER
...
/turf/open/floor/plating/ms13/ground/desert
	...
	smoothing_groups = SMOOTH_GROUP_MS13_DESERT
	canSmoothWith = DESERT_SMOOTHING
...
/turf/open/floor/plating/ms13/ground/desertalt
	...
	smoothing_groups = SMOOTH_GROUP_MS13_DESERT
	canSmoothWith = SMOOTH_GROUP_MS13_DESERT
	layer = TURF_LAYER
...
/turf/open/floor/plating/ms13/ground/snow
	...
	canSmoothWith = SMOOTH_GROUP_MS13_SNOW + SMOOTH_GROUP_MS13_TILE + SMOOTH_GROUP_MS13_WATER
...
/turf/open/floor/plating/ms13/ground/road
	...
	canSmoothWith = SMOOTH_GROUP_MS13_SNOW + SMOOTH_GROUP_MS13_ROAD + SMOOTH_GROUP_MS13_SIDEWALK + SMOOTH_GROUP_MS13_TILE + SMOOTH_GROUP_MS13_WATER + SMOOTH_GROUP_MS13_OPENSPACE
...
/turf/open/floor/plating/ms13/ground/sidewalk
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_MS13_SIDEWALK
	canSmoothWith = WALL_OBJECT_SMOOTHING + SMOOTH_GROUP_TURF_OPEN + SMOOTH_GROUP_MS13_DESERT + SMOOTH_GROUP_MS13_SIDEWALK + SMOOTH_GROUP_MS13_TILE
...
/turf/open/floor/plating/ms13/roof
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_TURF_OPEN + SMOOTH_GROUP_MS13_ROOF_NORMAL
	canSmoothWith = WALL_SMOOTHING + SMOOTH_GROUP_MS13_ROOF_NORMAL
...
/turf/open/floor/plating/ms13/roof/sheet
	...
	smoothing_groups = SMOOTH_GROUP_MS13_ROOF_SHEET
	canSmoothWith = WALL_SMOOTHING + SMOOTH_GROUP_MS13_ROOF_SHEET
...
/turf/open/floor/plating/ms13/roof/metal
	...
	canSmoothWith = WALL_SMOOTHING + SMOOTH_GROUP_MS13_ROOF_METAL
...
/turf/open/floor/plating/ms13/roof/wood
	...
	smoothing_groups = SMOOTH_GROUP_TURF_OPEN + SMOOTH_GROUP_MS13_ROOF_WOOD
	canSmoothWith = WALL_SMOOTHING + SMOOTH_GROUP_MS13_ROOF_WOOD
...
/turf/open/floor/plating/ms13/ground/ice
	...
	base_icon_state = "ice"
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_MS13_ICE
	canSmoothWith = WALL_OBJECT_SMOOTHING + SMOOTH_GROUP_TURF_OPEN + SMOOTH_GROUP_MS13_DESERT + SMOOTH_GROUP_MS13_SNOW + SMOOTH_GROUP_MS13_ROAD + SMOOTH_GROUP_MS13_SIDEWALK + SMOOTH_GROUP_MS13_TILE + SMOOTH_GROUP_MS13_ICE
...
/turf/open/ms13/water
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_MS13_WATER
	canSmoothWith = SMOOTH_GROUP_MS13_WATER
...
/turf/open/openspace/ms13
	...
	can_build_on = FALSE
	can_cover_up = FALSE
	smoothing_groups = SMOOTH_GROUP_MS13_OPENSPACE

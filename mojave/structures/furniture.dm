...
/obj/structure/ms13/tv/Initialize()
	. = ..()
	register_context()
	AddComponent(/datum/component/ms13_searchable, loot_table = /obj/effect/spawner/random/ms13/crafting/electrical, slots = 2, max_item_size = WEIGHT_CLASS_SMALL, max_total = 4, open_tool = TOOL_SCREWDRIVER, search_message = "You unscrew the back panel.")
	AddElement(/datum/element/ms13_wired_look)
...
/obj/structure/ms13/pay_phone/Initialize()
	. = ..()
	register_context()
	AddComponent(/datum/component/ms13_searchable, loot_table = /obj/effect/spawner/random/ms13/currency/mammoth/prewar/lowrandom, slots = 2, max_item_size = WEIGHT_CLASS_TINY, max_total = 2, open_tool = TOOL_CROWBAR, search_message = "You pry the coin box open.")
	AddElement(/datum/element/ms13_wired_look)
...
/obj/structure/ms13/jukebox/Initialize()
	. = ..()
	register_context()
	AddComponent(/datum/component/ms13_searchable, loot_table = /obj/effect/spawner/random/ms13/crafting/electrical, slots = 3, max_item_size = WEIGHT_CLASS_SMALL, max_total = 6, open_tool = TOOL_SCREWDRIVER, search_message = "You unscrew the service panel.")
	AddElement(/datum/element/ms13_wired_look)

...
/obj/structure/ms13/vehicle_ruin/Initialize()
	. = ..()
	register_context()
	AddComponent(/datum/component/ms13_searchable, loot_table = /obj/effect/spawner/random/ms13/tools/tool, slots = 6, max_item_size = WEIGHT_CLASS_NORMAL, max_total = 14, open_tool = TOOL_CROWBAR, open_time = 5 SECONDS, search_message = "You pry the rusted trunk open.")

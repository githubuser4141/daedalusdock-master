...
/obj/machinery/power/ms13/streetlamp/Initialize()
	. = ..()
	AddComponent(/datum/component/ms13_searchable, loot_table = /obj/effect/spawner/random/ms13/tools/lights, slots = 1, max_item_size = WEIGHT_CLASS_TINY, max_total = 2, open_tool = TOOL_CROWBAR, search_message = "You pry open the access panel at the base of the lamp.")
